<?php
	...
	start();
?>
		<br/><span style="background:#234" onClick="newKierunek()"><a href="#">Dodaj</a></span><br/><br/>
	...
	if (isLogged())
	{
		...
		{	
		?>
		<tr class="gradeB" style="cursor: pointer;" onClick="getKierunek(<?php echo $row['id_kierunek'];?>)">
			<td style="text-align:center"><?php echo $row['id_kierunek'];?></td>			
