<?php
 ...
 if (isLogged())
 {
	...
	$result = mysql_query("select m.title, m.timestamp, m.body, u.email from messages m, users u where m.id_messages=$id_messages and (m.id_reciver=".getId()." or m.id_sender=".getId().") and u.id_users=m.id_sender");
...
?>
	Nowa wiadomość<br/><br/>
			<aside>
				...
				<p><span>Tytuł: </span><input type="text" id="title" size="79" value="<?php echo $row['title']; ?>"></p>														
			</aside>
			<aside>
