  ...
  <div class="form-all">
    <ul class="form-section">
      ...
      <li class="form-line" id="id_20">
        <label class="form-label-left" id="label_20" for="input_20"> Tytuł Imię i Nazwisko </label>
        <div id="cid_20" class="form-input">
          <input type="text" class="form-textbox" id="input_20" name="dodajwykladowca_nazwa" size="20" />
        </div>
      </li>
